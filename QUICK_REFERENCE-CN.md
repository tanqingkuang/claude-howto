...
# 结合 hooks 做自动化
# 参见 09-advanced-features/README-CN.md
```
...
### 按使用场景
- **性能**：`01-slash-commands/optimize-CN.md`
- **安全**：`04-subagents/secure-reviewer-CN.md`
- **测试**：`04-subagents/test-engineer-CN.md`
...
| 安全实验 | Checkpoint | `08-checkpoints/checkpoint-examples-CN.md` |
| 完全自治 | Auto Mode | `--enable-auto-mode` 或 `Shift+Tab` |
| 聊天集成 | Channels | `--channels`（Discord、Telegram） |
| CI/CD 流水线 | CLI | `10-cli/README-CN.md` |
...
- **主指南**：`README-CN.md`
- **完整索引**：`INDEX-CN.md`
- **速查卡**：`QUICK_REFERENCE-CN.md`
- **原始指南**：`claude_concepts_guide-CN.md`
...
**快速开始**：`cat README-CN.md`

**完整索引**：`cat INDEX-CN.md`
