...
更多可直接参考的中文示例见 [checkpoint-examples-CN.md](checkpoint-examples-CN.md)。
...
- **Memory**：跨会话的长期上下文，见 [02-memory/README-CN.md](../02-memory/README-CN.md)
- **Hooks**：事件驱动自动化，见 [06-hooks/README-CN.md](../06-hooks/README-CN.md)
- **Plugins**：打包功能集合，见 [07-plugins/README-CN.md](../07-plugins/README-CN.md)
- **Advanced Features**：包括 planning mode 和背景任务，见 [09-advanced-features/README-CN.md](../09-advanced-features/README-CN.md)

## 更多资源

- [根目录中文指南](../README-CN.md)
- [Claude Code 官方检查点文档](https://code.claude.com/docs/en/checkpointing)
- [Claude Code 高级功能指南](../09-advanced-features/README-CN.md)
