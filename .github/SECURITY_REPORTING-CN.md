...
- **安全政策**：[SECURITY-CN.md](../SECURITY-CN.md)
- **报告模板**：见下文
...
1. 查看 [SECURITY-CN.md](../SECURITY-CN.md) 的完整政策
2. 查看下方的 [FAQ](#faq)
...
- [SECURITY-CN.md](../SECURITY-CN.md) - 完整安全政策
- [CONTRIBUTING-CN.md](../CONTRIBUTING-CN.md) - 贡献指南
- [CODE_OF_CONDUCT-CN.md](../CODE_OF_CONDUCT-CN.md) - 社区标准
