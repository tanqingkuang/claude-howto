...
| 类型 | 约定 | 示例 |
|------|-----------|----------|
| **课程 README** | `README-CN.md` | `01-slash-commands/README-CN.md` |
...
```markdown
[Slash Commands](01-slash-commands/README-CN.md)
[Skills Guide](03-skills/README-CN.md)
[Memory Architecture](02-memory/README-CN.md)
```
...
```markdown
[返回主指南](README-CN.md)
[相关：Skills](03-skills/README-CN.md)
```
...
- [Slash Commands](01-slash-commands/README-CN.md) - 快速快捷命令
- [Memory](02-memory/README-CN.md) - 持久上下文
- [Skills](03-skills/README-CN.md) - 可复用能力
```
