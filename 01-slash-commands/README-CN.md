...
> **注意**：自定义 slash command 已经合并进 Skills。`.claude/commands/` 仍然可用，但现在更推荐使用 `.claude/skills/`。两者都会创建 `/command-name` 形式的快捷命令。完整参考请见 [Skills 指南](../03-skills/README-CN.md)。
...
- **[Subagents](../04-subagents/README-CN.md)** - 委派式 AI agents
