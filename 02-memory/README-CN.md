...
```bash
cp project-CLAUDE-CN.md CLAUDE.md
```
...
```bash
cp personal-CLAUDE-CN.md ~/.claude/CLAUDE.md
```

### 设置目录记忆

```bash
cp directory-api-CLAUDE-CN.md src/api/CLAUDE.md
```
...
- [Subagents 中文参考](../04-subagents/README-CN.md)
- [Advanced Features 中文指南](../09-advanced-features/README-CN.md)
