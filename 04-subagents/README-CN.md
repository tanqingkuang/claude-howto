...
### 1. [Code Reviewer](./code-reviewer-CN.md)

用于全面代码质量审查。

### 2. [Test Engineer](./test-engineer-CN.md)

用于测试策略、覆盖率和测试生成。

### 3. [Documentation Writer](./documentation-writer-CN.md)

用于技术文档写作和更新。

### 4. [Secure Reviewer](./secure-reviewer-CN.md)

用于安全检查，通常只读。

### 5. [Implementation Agent](./implementation-agent-CN.md)

用于功能实现和代码修改。

### 6. [Debugger](./debugger-CN.md)

用于定位 bug 和分析异常。

### 7. [Data Scientist](./data-scientist-CN.md)

用于分析数据、解释结果和生成报告。

### 8. [Clean Code Reviewer](./clean-code-reviewer-CN.md)
...
- [Skills 中文指南](../03-skills/README-CN.md)
- [Memory 中文指南](../02-memory/README-CN.md)
- [Hooks 中文指南](../06-hooks/README-CN.md)
- [Plugins 中文指南](../07-plugins/README-CN.md)
