...
| 文件 | 说明 | 使用场景 |
|------|------|----------|
| `optimize-CN.md` | 代码优化分析器 | 查找性能问题 |
| `pr-CN.md` | Pull Request 准备 | PR 工作流自动化 |
| `generate-api-docs-CN.md` | API 文档生成器 | 生成 API 文档 |
| `commit-CN.md` | 提交信息助手 | 统一提交风格 |
| `setup-ci-cd-CN.md` | CI/CD 流水线设置 | DevOps 自动化 |
| `push-all-CN.md` | 推送所有变更 | 快速推送工作流 |
| `unit-test-expand-CN.md` | 扩展单元测试覆盖率 | 测试自动化 |
| `doc-refactor-CN.md` | 文档重构 | 文档优化 |
| `pr-slash-command.png` | 截图示例 | 视觉参考 |
| `README-CN.md` | 文档 | 安装与使用指南 |
...
| 文件 | 说明 | 范围 | 位置 |
|------|------|------|------|
| `project-CLAUDE-CN.md` | 团队项目规范 | 整个项目 | `./CLAUDE.md` |
| `directory-api-CLAUDE-CN.md` | API 专用规则 | 目录级 | `./src/api/CLAUDE.md` |
| `personal-CLAUDE-CN.md` | 个人偏好 | 用户级 | `~/.claude/CLAUDE.md` |
| `memory-saved.png` | 截图：记忆已保存 | - | 视觉参考 |
| `memory-ask-claude.png` | 截图：询问 Claude | - | 视觉参考 |
| `README-CN.md` | 文档 | - | 参考说明 |
...
```text
code-review/
├── SKILL-CN.md                     # Skill 定义
├── scripts/
│   ├── analyze-metrics.py          # 代码指标分析器
│   └── compare-complexity.py       # 复杂度对比
└── templates/
    ├── review-checklist-CN.md      # 审查清单
    └── finding-template-CN.md      # 问题记录模板
```
...
├── references/
│   ├── code-smells-CN.md           # 代码异味目录
│   └── refactoring-catalog-CN.md   # 重构模式目录
└── templates/
    └── refactoring-plan-CN.md      # 重构计划模板
```
...
├── SKILL-CN.md                     # Skill 定义
└── templates/
    ├── draft-template-CN.md        # 博客草稿模板
    └── outline-template-CN.md      # 博客大纲模板
```

**用途**：生成结构统一的博客草稿

**补充**：`README-CN.md` - Skills 总览与使用指南
...
| 文件 | 说明 | 工具 | 使用场景 |
|------|------|------|----------|
| `code-reviewer-CN.md` | 代码质量分析 | read, grep, diff, lint_runner | 完整审查 |
| `test-engineer-CN.md` | 测试覆盖分析 | read, write, bash, grep | 测试自动化 |
| `documentation-writer-CN.md` | 文档创建 | read, write, grep | 文档生成 |
| `secure-reviewer-CN.md` | 安全审查（只读） | read, grep | 安全审计 |
| `implementation-agent-CN.md` | 完整实现 | read, write, bash, grep, edit, glob | 功能开发 |
| `debugger-CN.md` | 调试专家 | read, bash, grep | Bug 排查 |
| `data-scientist-CN.md` | 数据分析专家 | read, write, bash | 数据工作流 |
| `clean-code-reviewer-CN.md` | 代码整洁性规范 | read, grep | 代码质量 |
| `README-CN.md` | 文档 | - | 安装与使用指南 |
...
│   └── plugin.json                  # 插件清单
├── commands/
│   ├── review-pr-CN.md              # 综合审查
│   ├── check-security-CN.md         # 安全检查
│   └── check-tests-CN.md            # 测试覆盖检查
├── agents/
│   ├── security-reviewer-CN.md      # 安全专家
│   ├── test-checker-CN.md           # 测试专家
│   └── performance-analyzer-CN.md   # 性能专家
├── mcp/
...
│   └── incident-CN.md               # 事件响应
├── agents/
│   ├── deployment-specialist-CN.md  # 部署专家
│   ├── incident-commander-CN.md     # 事件协调
│   └── alert-analyzer-CN.md         # 告警分析
├── mcp/
...
│   └── plugin.json                  # 插件清单
├── commands/
│   ├── generate-api-docs-CN.md      # API 文档生成
│   ├── generate-readme-CN.md        # README 创建
│   ├── sync-docs-CN.md              # 文档同步
│   └── validate-docs-CN.md          # 文档校验
├── agents/
│   ├── api-documenter-CN.md         # API 文档专家
│   ├── code-commentator-CN.md       # 代码注释专家
│   └── example-generator-CN.md      # 示例生成器
├── mcp/
│   └── github-docs-config.json      # GitHub 集成
├── templates/
│   ├── api-endpoint-CN.md           # API 端点模板
│   ├── function-docs-CN.md          # 函数文档模板
│   └── adr-template-CN.md           # ADR 模板
└── README-CN.md                     # 插件文档
```
...
| 文件 | 说明 | 内容 |
|------|------|------|
| `README-CN.md` | 文档 | 完整的 checkpoint 指南 |
| `checkpoint-examples-CN.md` | 真实示例 | 数据库迁移、性能优化、UI 迭代、调试 |
...
| 文件 | 说明 | 功能 |
|------|------|------|
| `README-CN.md` | 完整指南 | 全部高级功能说明 |
| `config-examples.json` | 配置示例 | 10+ 个场景化配置 |
| `planning-mode-examples-CN.md` | 规划示例 | REST API、数据库迁移、重构 |
...
| 文件 | 说明 | 内容 |
|------|------|------|
| `README-CN.md` | CLI 文档 | 参数、选项与使用模式 |
...
| `README-CN.md` | `/08-checkpoints/` | Checkpoints 指南 |
| `README-CN.md` | `/09-advanced-features/` | Advanced Features 指南 |
| `README-CN.md` | `/10-cli/` | CLI 指南 |
...
├── INDEX-CN.md                                   # 本文件
├── QUICK_REFERENCE-CN.md                         # 速查卡片
├── claude_concepts_guide-CN.md                   # 原始指南
│
...
│   │   └── templates/
│   │       ├── review-checklist-CN.md
│   │       └── finding-template-CN.md
│   ├── brand-voice/
│   │   ├── SKILL-CN.md
│   │   ├── templates/
│   │   │   ├── email-template.txt
...
│   │   ├── references/
│   │   │   ├── code-smells-CN.md
│   │   │   └── refactoring-catalog-CN.md
│   │   └── templates/
│   │       └── refactoring-plan-CN.md
│   ├── claude-md/
│   │   └── SKILL-CN.md
│   ├── blog-draft/
│   │   ├── SKILL-CN.md
│   │   └── templates/
│   │       ├── draft-template-CN.md
│   │       └── outline-template-CN.md
│   └── README-CN.md
│
...
│   ├── debugger-CN.md
│   ├── data-scientist-CN.md
│   ├── clean-code-reviewer-CN.md
│   └── README-CN.md
│
├── 05-mcp/                                       # MCP Protocol
│   ├── github-mcp.json
...
│   │   ├── commands/
│   │   │   ├── review-pr-CN.md
│   │   │   ├── check-security-CN.md
│   │   │   └── check-tests-CN.md
│   │   ├── agents/
│   │   │   ├── security-reviewer-CN.md
│   │   │   ├── test-checker-CN.md
│   │   │   └── performance-analyzer-CN.md
│   │   ├── mcp/
│   │   │   └── github-config.json
│   │   ├── hooks/
│   │   │   └── pre-review.js
...
│   │   │   └── incident-CN.md
│   │   ├── agents/
│   │   │   ├── deployment-specialist-CN.md
│   │   │   ├── incident-commander-CN.md
│   │   │   └── alert-analyzer-CN.md
│   │   ├── mcp/
...
│   │   ├── commands/
│   │   │   ├── generate-api-docs-CN.md
│   │   │   ├── generate-readme-CN.md
│   │   │   ├── sync-docs-CN.md
│   │   │   └── validate-docs-CN.md
│   │   ├── agents/
│   │   │   ├── api-documenter-CN.md
│   │   │   ├── code-commentator-CN.md
│   │   │   └── example-generator-CN.md
│   │   ├── mcp/
...
# 参见 08-checkpoints/README-CN.md 的示例
```
...
# 参见 09-advanced-features/README-CN.md 获取完整指南
```
...
- `01-slash-commands/optimize-CN.md` - 性能分析
- `04-subagents/code-reviewer-CN.md` - 性能审查
- `03-skills/code-review/` - 性能指标
- `07-plugins/pr-review/agents/performance-analyzer-CN.md` - 性能专家

### 安全

- `04-subagents/secure-reviewer-CN.md` - 安全审查
- `03-skills/code-review/` - 安全分析
- `07-plugins/pr-review/` - 安全检查

### 测试

- `04-subagents/test-engineer-CN.md` - 测试工程师
- `07-plugins/pr-review/commands/check-tests-CN.md` - 测试覆盖率
...
- `08-checkpoints/checkpoint-examples-CN.md` - 真实示例

### 规划

- `09-advanced-features/planning-mode-examples-CN.md` - 规划模式示例
- `09-advanced-features/README-CN.md` - 深度思考
