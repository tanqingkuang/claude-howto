...
[![Version](https://img.shields.io/badge/version-2.2.0-brightgreen)](CHANGELOG-CN.md)
[![Claude Code](https://img.shields.io/badge/Claude_Code-2.1+-purple)](https://code.claude.com)

# 用一个周末掌握 Claude Code

从输入 `claude` 开始，到编排子代理、hooks、Skills 和 MCP 服务器，全程配有可视化教程、可直接复制粘贴的模板，以及循序渐进的学习路径。

**[15 分钟快速上手](#15-分钟快速上手)** | **[找到适合你的起点](#不知道从哪里开始)** | **[浏览功能目录](CATALOG-CN.md)**
...
- **官方文档会介绍功能，但不会告诉你如何把它们组合起来。** 你知道斜杠命令存在，但不知道怎样把它们和 hooks、memory、子代理串起来，形成一个真正能节省数小时的工作流。
- **没有清晰的学习路径。** 应该先学 MCP 还是 hooks？先学 Skills 还是子代理？结果往往是每样都看了一点，但没有一个真正掌握。
...
- **10 个教程模块**，覆盖 Claude Code 的所有核心功能，从斜杠命令到自定义 agent 团队
- **可复制粘贴的配置**，包括斜杠命令、`CLAUDE.md` 模板、hook 脚本、MCP 配置、子代理定义，以及完整插件打包
...
完成[自我评估测验](LEARNING-ROADMAP-CN.md#find-your-level)，或者在 Claude Code 中运行 `/self-assessment`。系统会根据你已经掌握的内容，生成一份个性化学习路线。
...
真正的威力来自功能组合。你会学到如何把斜杠命令、memory、子代理和 hooks 连接成自动化流水线，用于代码审查、部署和文档生成等任务。
...
| Level | 你可以…… | 从这里开始 | 时间 |
|-------|-----------|------------|------|
| **Beginner** | 启动 Claude Code 并进行对话 | [Slash Commands](01-slash-commands/README-CN.md) | 约 2.5 小时 |
| **Intermediate** | 使用 `CLAUDE.md` 和自定义命令 | [Skills](03-skills/README-CN.md) | 约 3.5 小时 |
| **Advanced** | 配置 MCP 服务器和 hooks | [Advanced Features](09-advanced-features/README-CN.md) | 约 5 小时 |

**完整学习路径，共 10 个模块：**

| 顺序 | 模块 | 水平 | 时间 |
|-------|--------|-------|------|
| 1 | [Slash Commands](01-slash-commands/README-CN.md) | 初学者 | 30 分钟 |
| 2 | [Memory](02-memory/README-CN.md) | 初学者+ | 45 分钟 |
| 3 | [Checkpoints](08-checkpoints/README-CN.md) | 中级 | 45 分钟 |
| 4 | [CLI Basics](10-cli/README-CN.md) | 初学者+ | 30 分钟 |
| 5 | [Skills](03-skills/README-CN.md) | 中级 | 1 小时 |
| 6 | [Hooks](06-hooks/README-CN.md) | 中级 | 1 小时 |
| 7 | [MCP](05-mcp/README-CN.md) | 中级+ | 1 小时 |
| 8 | [子代理](04-subagents/README-CN.md) | 中级+ | 1.5 小时 |
| 9 | [Advanced Features](09-advanced-features/README-CN.md) | 高级 | 2 到 3 小时 |
| 10 | [Plugins](07-plugins/README-CN.md) | 高级 | 2 小时 |

**[完整学习路线图 ->](LEARNING-ROADMAP-CN.md)**
...
cp 01-slash-commands/optimize-CN.md /path/to/your-project/.claude/commands/

# 3. 试试看：在 Claude Code 中输入
# /optimize

# 4. 想更进一步？设置项目记忆：
cp 02-memory/project-CLAUDE-CN.md /path/to/your-project/CLAUDE.md
...
| 使用场景 | 你会组合使用的功能 |
|----------|------------------------|
| **自动化代码审查** | 斜杠命令 + 子代理 + Memory + MCP |
| **团队入职培训** | Memory + 斜杠命令 + 插件 |
| **CI/CD 自动化** | CLI Reference + Hooks + Background Tasks |
| **文档生成** | Skills + 子代理 + 插件 |
| **安全审计** | 子代理 + Skills + Hooks（只读模式） |
...
**我可以参与贡献吗？**  
当然可以。请查看 [CONTRIBUTING-CN.md](CONTRIBUTING-CN.md) 了解贡献规范。我们欢迎新的示例、bug 修复、文档改进以及社区模板。
...
**[开始学习路线 ->](LEARNING-ROADMAP-CN.md)** | **[浏览功能目录](CATALOG-CN.md)** | **[15 分钟快速上手](#15-分钟快速上手)**
...
| 功能 | 说明 | 文件夹 |
|---------|-------------|--------|
| **功能目录** | 包含安装命令的完整参考 | [CATALOG-CN.md](CATALOG-CN.md) |
| **斜杠命令** | 用户手动触发的快捷命令 | [01-slash-commands/README-CN.md](01-slash-commands/README-CN.md) |
| **Memory** | 持久上下文 | [02-memory/README-CN.md](02-memory/README-CN.md) |
| **Skills** | 可复用能力 | [03-skills/README-CN.md](03-skills/README-CN.md) |
| **子代理** | 专门化 AI 助手 | [04-subagents/README-CN.md](04-subagents/README-CN.md) |
| **MCP Protocol** | 访问外部工具 | [05-mcp/README-CN.md](05-mcp/README-CN.md) |
| **Hooks** | 事件驱动自动化 | [06-hooks/README-CN.md](06-hooks/README-CN.md) |
| **Plugins** | 打包后的功能集合 | [07-plugins/README-CN.md](07-plugins/README-CN.md) |
| **Checkpoints** | 会话快照与回退 | [08-checkpoints/README-CN.md](08-checkpoints/README-CN.md) |
| **Advanced Features** | 规划、思考、后台任务 | [09-advanced-features/README-CN.md](09-advanced-features/README-CN.md) |
| **CLI Reference** | 命令、参数与选项 | [10-cli/README-CN.md](10-cli/README-CN.md) |
...
**位置**: [01-slash-commands/README-CN.md](01-slash-commands/README-CN.md)

**是什么**: 以 Markdown 文件形式存储、由用户手动触发的快捷命令

**示例**:
- `optimize-CN.md` - 代码优化分析
- `pr-CN.md` - Pull Request 准备
- `generate-api-docs-CN.md` - API 文档生成器

**安装**:
```bash
cp 01-slash-commands/*-CN.md /path/to/project/.claude/commands/
```
...
**位置**: [02-memory/README-CN.md](02-memory/README-CN.md)

**是什么**: 跨会话持久化的上下文

**示例**:
- `project-CLAUDE-CN.md` - 团队共享的项目规范
- `directory-api-CLAUDE-CN.md` - 目录级规则
- `personal-CLAUDE-CN.md` - 个人偏好

**安装**:
```bash
# 项目记忆
cp 02-memory/project-CLAUDE-CN.md /path/to/project/CLAUDE.md

# 目录记忆
cp 02-memory/directory-api-CLAUDE-CN.md /path/to/project/src/api/CLAUDE.md

# 个人记忆
cp 02-memory/personal-CLAUDE-CN.md ~/.claude/CLAUDE.md
```
...
**位置**: [03-skills/README-CN.md](03-skills/README-CN.md)
...
**位置**: [04-subagents/README-CN.md](04-subagents/README-CN.md)
...
**安装**:
```bash
cp 04-subagents/*-CN.md /path/to/project/.claude/agents/
```
...
**位置**: [05-mcp/README-CN.md](05-mcp/README-CN.md)
...
# 或手动添加到项目 .mcp.json（参见 [05-mcp/README-CN.md](05-mcp/README-CN.md) 中的示例）
```
...
**位置**: [06-hooks/README-CN.md](06-hooks/README-CN.md)
...
**位置**: [07-plugins/README-CN.md](07-plugins/README-CN.md)
...
**位置**: [08-checkpoints/README-CN.md](08-checkpoints/README-CN.md)
...
**位置**: [09-advanced-features/README-CN.md](09-advanced-features/README-CN.md)
...
**位置**: [10-cli/README-CN.md](10-cli/README-CN.md)
...
│   ├── optimize-CN.md
│   ├── pr-CN.md
│   ├── generate-api-docs-CN.md
│   └── README-CN.md
├── 02-memory/
│   ├── project-CLAUDE-CN.md
│   ├── directory-api-CLAUDE-CN.md
│   ├── personal-CLAUDE-CN.md
│   └── README-CN.md
├── 03-skills/
│   ├── code-review/
│   │   ├── SKILL-CN.md
...
│   ├── code-reviewer-CN.md
│   ├── test-engineer-CN.md
│   ├── documentation-writer-CN.md
│   ├── secure-reviewer-CN.md
│   ├── implementation-agent-CN.md
│   └── README-CN.md
├── 05-mcp/
│   ├── github-mcp.json
│   ├── database-mcp.json
...
│   └── README-CN.md
├── 08-checkpoints/
│   ├── checkpoint-examples-CN.md
│   └── README-CN.md
├── 09-advanced-features/
│   ├── config-examples.json
│   ├── planning-mode-examples-CN.md
│   └── README-CN.md
├── 10-cli/
│   └── README-CN.md
└── README-CN.md（本文件）
...
每次 push 到 `main` / `develop`，以及每次向 `main` 提交 PR 时，测试都会自动运行。详情见 [TESTING-CN.md](.github/TESTING-CN.md)。
...
更多选项见 [scripts/README-CN.md](scripts/README-CN.md)。
...
**请先阅读 [CONTRIBUTING-CN.md](CONTRIBUTING-CN.md)，了解以下详细规范：**
...
**我们的社区标准：**
- [CODE_OF_CONDUCT-CN.md](CODE_OF_CONDUCT-CN.md) - 我们如何彼此相处
- [SECURITY-CN.md](SECURITY-CN.md) - 安全政策与漏洞报告方式
...
2. **或者阅读** [.github/SECURITY_REPORTING-CN.md](.github/SECURITY_REPORTING-CN.md) 获取详细说明
3. **不要**公开提交安全漏洞 issue
...
欢迎贡献内容。如何开始请查看我们的[贡献指南](CONTRIBUTING-CN.md)。
