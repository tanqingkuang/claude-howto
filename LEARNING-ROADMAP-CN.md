...
| **9** | [Advanced Features](09-advanced-features/README-CN.md) | ⭐⭐⭐⭐⭐ Advanced | 2-3 小时 | Level 3 | 前面所有内容 | 高阶工具 | Planning、自动模式（Auto Mode）、通道（Channels）、语音输入、权限控制 |
| **10** | [Plugins](07-plugins/README-CN.md) | ⭐⭐⭐⭐ Advanced | 2 小时 | Level 3 | 前面所有内容 | 完整解决方案 | 团队入职、分发 |
| **11** | [CLI Mastery](10-cli/README-CN.md) | ⭐⭐⭐ Advanced | 1 小时 | Level 3 | 建议：全部 | 掌握命令行用法 | 脚本、CI/CD、自动化 |
...
#### 下一步
熟悉之后，请阅读：
- [01-slash-commands/README-CN.md](01-slash-commands/README-CN.md)
- [02-memory/README-CN.md](02-memory/README-CN.md)
...
#### 下一步
- 阅读：[09-advanced-features/README-CN.md](09-advanced-features/README-CN.md)
...
1. 复制一个 slash command：`cp 01-slash-commands/optimize-CN.md .claude/commands/`
2. 在 Claude Code 中试一下：`/optimize`
3. 阅读：[01-slash-commands/README-CN.md](01-slash-commands/README-CN.md)
...
### 🟢 Level 1：Beginner
- [ ] 完成 [01-slash-commands](01-slash-commands/README-CN.md)
- [ ] 完成 [02-memory](02-memory/README-CN.md)
...
### 🔴 Level 3：Advanced
- [ ] 完成 [09-advanced-features](09-advanced-features/README-CN.md)
- [ ] 成功使用 planning mode
...
### 难题 2：“不知道什么时候该用哪个功能”
**解决**：回到主 README 里的 [Use Case Matrix](README-CN.md#你能用它做什么)。

### 难题 3：“配置没有生效”
**解决**：检查主 README 里的 [Troubleshooting](README-CN.md#故障排查) 部分，并确认文件路径。

### 难题 4：“概念之间好像重叠”
**解决**：查看主 README 里的 [Feature Comparison](README-CN.md#功能对比) 表，理解差异。
