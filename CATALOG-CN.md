...
| 功能 | 内置 | 示例 | 总数 | 参考 |
|---------|----------|----------|-------|-----------|
| **Slash Commands** | 55+ | 8 | 63+ | [01-slash-commands/README-CN.md](01-slash-commands/README-CN.md) |
| **Subagents** | 6 | 10 | 16 | [04-subagents/README-CN.md](04-subagents/README-CN.md) |
| **Skills** | 5 个内置 | 4 | 9 | [03-skills/README-CN.md](03-skills/README-CN.md) |
| **Plugins** | - | 3 | 3 | [07-plugins/README-CN.md](07-plugins/README-CN.md) |
| **MCP Servers** | 1 | 8 | 9 | [05-mcp/README-CN.md](05-mcp/README-CN.md) |
| **Hooks** | 25 个事件 | 7 | 7 | [06-hooks/README-CN.md](06-hooks/README-CN.md) |
| **Memory** | 7 种类型 | 3 | 3 | [02-memory/README-CN.md](02-memory/README-CN.md) |
| **总计** | **99** | **43** | **117** | |
...
| 命令 | 说明 | 适用场景 | 作用域 | 安装 |
|---------|-------------|-------------|-------|--------------|
| `/optimize` | 分析代码以做优化 | 性能改进 | 项目 | `cp 01-slash-commands/optimize-CN.md .claude/commands/` |
| `/pr` | 准备 Pull Request | 提交 PR 前 | 项目 | `cp 01-slash-commands/pr-CN.md .claude/commands/` |
| `/generate-api-docs` | 生成 API 文档 | 编写 API 文档 | 项目 | `cp 01-slash-commands/generate-api-docs-CN.md .claude/commands/` |
| `/commit` | 结合上下文创建 git commit | 提交变更 | 用户 | `cp 01-slash-commands/commit-CN.md .claude/commands/` |
| `/push-all` | 先暂存、提交再 push | 快速发布 | 用户 | `cp 01-slash-commands/push-all-CN.md .claude/commands/` |
| `/doc-refactor` | 重构文档结构 | 改进文档 | 项目 | `cp 01-slash-commands/doc-refactor-CN.md .claude/commands/` |
| `/setup-ci-cd` | 搭建 CI/CD 流水线 | 新项目 | 项目 | `cp 01-slash-commands/setup-ci-cd-CN.md .claude/commands/` |
| `/unit-test-expand` | 扩展测试覆盖率 | 改进测试 | 项目 | `cp 01-slash-commands/unit-test-expand-CN.md .claude/commands/` |

> **作用域**: `User` = 个人工作流（`~/.claude/commands/`），`Project` = 团队共享（`.claude/commands/`）

**参考**: [01-slash-commands/README-CN.md](01-slash-commands/README-CN.md) | [官方文档](https://code.claude.com/docs/en/interactive-mode)
...
|-------|-------------|-------------|-------|--------------|
| `code-reviewer` | 全面的代码质量检查 | 代码审查会话 | 项目 | `cp 04-subagents/code-reviewer-CN.md .claude/agents/` |
| `code-architect` | 功能架构设计 | 新功能规划 | 项目 | `cp 04-subagents/code-architect-CN.md .claude/agents/` |
| `code-explorer` | 深入分析代码库 | 理解已有功能 | 项目 | `cp 04-subagents/code-explorer-CN.md .claude/agents/` |
| `clean-code-reviewer` | 按 Clean Code 原则审查 | 可维护性审查 | 项目 | `cp 04-subagents/clean-code-reviewer-CN.md .claude/agents/` |
| `test-engineer` | 测试策略与覆盖率 | 测试规划 | 项目 | `cp 04-subagents/test-engineer-CN.md .claude/agents/` |
| `documentation-writer` | 技术文档编写 | API 文档、指南 | 项目 | `cp 04-subagents/documentation-writer-CN.md .claude/agents/` |
| `secure-reviewer` | 面向安全的审查 | 安全审计 | 项目 | `cp 04-subagents/secure-reviewer-CN.md .claude/agents/` |
| `implementation-agent` | 完整功能实现 | 功能开发 | 项目 | `cp 04-subagents/implementation-agent-CN.md .claude/agents/` |
| `debugger` | 根因分析 | Bug 调查 | 用户 | `cp 04-subagents/debugger-CN.md .claude/agents/` |
| `data-scientist` | SQL 查询、数据分析 | 数据任务 | 用户 | `cp 04-subagents/data-scientist-CN.md .claude/agents/` |

> **作用域**: `User` = 个人（`~/.claude/agents/`），`Project` = 团队共享（`.claude/agents/`）

**参考**: [04-subagents/README-CN.md](04-subagents/README-CN.md) | [官方文档](https://code.claude.com/docs/en/sub-agents)
...
**参考**: [03-skills/README-CN.md](03-skills/README-CN.md) | [官方文档](https://code.claude.com/docs/en/skills)
...
**参考**: [07-plugins/README-CN.md](07-plugins/README-CN.md) | [官方文档](https://code.claude.com/docs/en/plugins)
...
**参考**: [05-mcp/README-CN.md](05-mcp/README-CN.md) | [MCP 协议文档](https://modelcontextprotocol.io)
...
**参考**: [06-hooks/README-CN.md](06-hooks/README-CN.md) | [官方文档](https://code.claude.com/docs/en/hooks)
...
**参考**: [02-memory/README-CN.md](02-memory/README-CN.md) | [官方文档](https://code.claude.com/docs/en/memory)
...
| 优先级 | 功能 | 命令 |
|----------|---------|---------|
| 1. 必装 | Memory | `cp 02-memory/project-CLAUDE-CN.md ./CLAUDE.md` |
| 2. 日常使用 | Slash Commands | `cp 01-slash-commands/*-CN.md .claude/commands/` |
| 3. 质量提升 | Subagents | `cp 04-subagents/*-CN.md .claude/agents/` |
