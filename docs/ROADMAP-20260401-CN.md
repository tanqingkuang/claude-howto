...
> 2026 年 4 月 – 2027 年 3 月 · 双层知识库 | 完整计划：`TASKS-20260401-CN.md`
...
目前几乎没有竞争者把 AI 代理视为主要受众，这就是我们的护城河。
...
**为什么从这里开始：** 基础设施会直接惠及后续所有阶段。hooks 和 checkpoints 是最薄弱的模块，也最容易流失新访客。
...
- `AGENT-INDEX.md`，从 `README-CN.md` 链接
